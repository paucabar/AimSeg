...
run("8-bit");
run("Import HDF5", "select="+dir+File.separator+substring(imageName, 0, indexOf(imageName, "."))+probabilitiesTag+" datasetname=[/exported_data: (4096, 4096, 3) float32] axisorder=xyc");
rename("3-channels");
